            ...
            $.ajax({
                ...
                success: function (data1) {
                    if (data == 'problem')
                        ...
                        $.jsontotable(data1, {id: '#FinalResultDiv', className: 'table table-hover datatable1 table-bordered mar0'});
                        ...
                        <div class="col-md-12 border-low">
                            <p class="text-center clearfix">
                                <button id='SearchButton' name='SearchButton' class="btn btn-olive margin5"
                                        onclick='startSearch(this.value)' value='Search' title='Search for artefact'>
                                    Search
                                </button>
                                <button id='ResetButton' name='ResetButton' class="btn btn-orange margin5"
                                        onClick='showTypes(this.value)' value='Reset' title='Reset my search'> Reset
                                </button>
                            </p>
                        </div>
